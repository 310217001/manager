...
namespace Pi.PiManager.IService.Base
{
    /// <summary>
    /// 基础服务定义
    /// </summary>
    ...
    public interface IBaseService<T> where T : class
    {
        ...
        /// <returns></returns>
        PagedInfo<T> GetPages(Expression<Func<T, bool>> where, PageParm parm, string orderFileds = null);
        ...
        /// <returns></returns>
        PagedInfo<T> GetPages(Expression<Func<T, bool>> where, PageParm parm, Expression<Func<T, object>> order, string orderEnum);

        List<T> GetNopage(Expression<Func<T, bool>> where, string orderFileds = null);
