...
namespace Pi.PiManager.Api.Filter
{
    /// <summary>
    /// 全局异常错误日志
    /// </summary>
    public class GlobalExceptionsFilter : IExceptionFilter
    {
        ...
        //[Obsolete]
        //public GlobalExceptionsFilter(IHostingEnvironment env, IloggerHelper loggerHelper, IExceptionLogService db)
        //{
        //    _env = env;
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            // 异常日志
            db.AddBugLog(context.Exception);
        }
